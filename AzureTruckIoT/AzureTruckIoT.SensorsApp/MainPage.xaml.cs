        ...
        protected override async void OnNavigatedTo(NavigationEventArgs navArgs)
        {
            try
            {
                ...
                if (deviceFamily.Equals("Windows.IoT"))
                {
                    ...
                    ///TODO: Uncomment these three lines when using face detection with camera and LCD screen:
                    //await InitializeCamera();
                    //await InitializeLCDServiceAsync();
                    //InitializeMotionService();

                    ///TODO: Comment out these four lines when using face detection with camera and LCD screen:
